        ...
        <div className="relative min-h-screen overflow-hidden bg-[#f0f0f0] dark:bg-stone-900 transition-colors duration-300" ref={containerRef}>
            ...
            <div className="absolute top-4 left-4 z-50 flex gap-4">
                <button
                    ...
                    className="bg-stone-800 text-white px-6 py-3 rounded-full font-bold shadow-lg hover:bg-stone-700 transition-transform hover:scale-105 flex items-center gap-2 dark:bg-stone-200 dark:text-stone-900 dark:hover:bg-stone-300"
                >
            ...
            <div className={clsx(
                "fixed top-0 right-0 h-full w-80 bg-white dark:bg-stone-800 shadow-2xl transform transition-transform duration-300 z-40 overflow-y-auto",
                ...
                {selectedPolaroid && (
                    <div className="p-6">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <button onClick={() => setSelectedPolaroidId(null)} aria-label="Close editor" className="text-stone-500 hover:text-stone-800 dark:text-stone-400 dark:hover:text-stone-200">
                                <X className="w-6 h-6" />
                            </button>
                        </div>
                        <PolaroidEditor
