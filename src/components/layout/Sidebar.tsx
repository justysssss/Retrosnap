...
export default function Sidebar() {
    ...
    return (
        <aside className="fixed left-0 top-0 h-full w-20 xl:w-64 bg-stone-900 text-stone-100 flex flex-col z-50 shadow-2xl transition-all duration-300">
            <Link href="/" className="p-6 flex items-center gap-3 border-b border-stone-800 hover:bg-stone-800 transition-colors">
                ...
                <span className="font-marker text-2xl hidden xl:block">RetroSnap</span>
            </Link>

            <nav className="flex-1 py-8 space-y-2 px-2 xl:px-4">
                {NAV_ITEMS.map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <span className="hidden xl:block font-handwriting text-xl">
                                {item.name}
                            </span>
                        </Link>
                    );
            ...
            <div className="p-4 border-t border-stone-800 flex flex-col gap-4">
                ...
                >
                    ...
                    <span className="hidden xl:block font-handwriting text-xl">Logout</span>
                </button>

                <p className="text-xs text-stone-500 text-center font-mono hidden xl:block">
                    v1.0.0 • Beta
                </p>
            </div>
        </aside>
