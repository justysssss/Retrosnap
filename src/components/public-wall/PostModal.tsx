          ...
          >
            ...
            {post.secretMessage && (
              <button
                ...
                className="absolute -top-10 right-0 z-50 flex items-center gap-2 text-white bg-stone-800/80 px-3 py-1.5 rounded-full text-xs hover:bg-stone-700/90 transition-colors"
                title="Flip polaroid"
              >
