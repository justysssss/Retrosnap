...
export default function BoardControls({
  ...
  return (
    <>
      ...
      <div className="fixed top-0 bottom-0 left-20 right-4 max-w-xs sm:max-w-sm xl:left-auto xl:right-0 xl:max-w-none xl:w-80 bg-white dark:bg-stone-800 z-[60] overflow-hidden flex flex-col">
        <div className="p-3 sm:p-4 flex-1 overflow-y-auto">
          <div className="flex justify-between items-center mb-4 sm:mb-6">
            <h3 className="font-marker text-lg sm:text-xl text-stone-800 dark:text-stone-200">Decorate</h3>
        ...
        <div className="p-4 sm:p-6 border-t border-stone-200 dark:border-stone-700 bg-stone-50 dark:bg-stone-900/50">
          <RetroButton
            onClick={onSave}
